...
class OklinkSDK extends OklinkBase{
public static function withApiKey($key, $secret)
{
    return new OklinkSDK(new Oklink_ApiKeyAuthentication($key, $secret));
}
public static function withSimpleApiKey($key)
{
    return new OklinkSDK(new Oklink_SimpleApiKeyAuthentication($key));
}
public static function withOAuth($oauth, $tokens)
{
    return new OklinkSDK(new Oklink_OAuthAuthentication($oauth, $tokens));
}
